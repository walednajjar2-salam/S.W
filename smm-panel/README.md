...
1. **توليد حسابات:** حدد العدد وبادئة البريد — تُنشأ الحسابات فوراً مع كلمات المرور (انسخها مباشرة).
2. **كود دعوة:** أنشئ كوداً مثل `SW-XXXXXXXX` ثم شاركه. التسجيل من `/register` يعمل فقط بهذا الكود.
